...
declare class UploadThingError<TShape extends Json = {
    ...
    static fromResponse(response: Response): Promise<UploadThingError<{
        message: string;
...
export { ALLOWED_FILE_TYPES, AllowedFileType, CombinedTypeValidator, ExpandedRouteConfig, FILESIZE_UNITS, FileData, FileRouterInputConfig, FileRouterInputKey, FileSize, FileSizeUnit, InternalFileTypeValidator, InternalMimeTypeValidator, Json, JsonArray, JsonObject, JsonValue, MimeTypeZod, SizeUnit, UploadThingError, UploadedFile, fileSizeToBytes, fillInputRouteConfig, generateUploadThingURL, getDefaultSizeForType, getStatusCodeFromError, getTypeFromFileName, getUploadthingUrl, isRouteArray, pollForFileData, withExponentialBackoff };
