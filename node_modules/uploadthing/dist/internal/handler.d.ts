...
import type { RequestLike } from "@uploadthing/shared";
...
export declare const buildRequestHandler: <TRouter extends FileRouter>(opts: RouterWithConfig<TRouter>) => (input: {
    req: RequestLike;
    res?: unknown;
    event?: unknown;
