...
export declare class UTApi {
     ...
     * ]);
     */
    uploadFiles<T extends FileEsque | FileEsque[]>(files: T, metadata?: Json): Promise<T extends FileEsque[] ? UploadFileResponse[] : UploadFileResponse>;
    /**
     ...
     * ])
     */
    uploadFilesFromUrl<T extends MaybeUrl | MaybeUrl[]>(urls: T, metadata?: Json): Promise<T extends MaybeUrl[] ? UploadFileResponse[] : UploadFileResponse>;
    /**
