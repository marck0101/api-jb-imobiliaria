...
var schema3 = import_zod2.z.object({
  ...
  type: import_zod2.z.enum(["SCHEDULED", "CHARTER", "UNIVERSITY"]).optional(),
  vehicle: import_zod2.z.custom().optional(),
  passengers: import_zod2.z.array(import_zod2.z.object({
    customer: import_zod2.z.string().min(1),
    seat: import_zod2.z.string().min(1)
  })).optional()
});
