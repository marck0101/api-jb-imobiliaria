...
var schema3 = import_zod2.z.object({
  type: import_zod2.z.enum(["1", "2"]),
  nre: import_zod2.z.string().nonempty(),
  renavam: import_zod2.z.string().nonempty(),
  licensePlate: import_zod2.z.string().nonempty(),
  uf: import_zod2.z.string().nonempty(),
  name: import_zod2.z.string().nonempty(),
  manufacturingYear: import_zod2.z.number().min(1950),
  modelYear: import_zod2.z.number().min(1950),
  //marca - modelo - versão
  mmv: import_zod2.z.string().nonempty(),
  taf: import_zod2.z.string().optional(),
  owner: import_zod2.z.object({
    cpf: import_zod2.z.string().optional(),
    cnpj: import_zod2.z.string().optional(),
    corporateName: import_zod2.z.string().nonempty(),
    ie: import_zod2.z.string().nonempty(),
    uf: import_zod2.z.string().nonempty(),
    type: import_zod2.z.enum(["0", "1", "2"]),
    taf: import_zod2.z.string().nonempty()
  })
});
...
var schema4 = import_zod3.z.object({
  type: import_zod3.z.enum(["1", "2"]).optional(),
  taf: import_zod3.z.string().optional(),
  renavam: import_zod3.z.string().optional(),
  licensePlate: import_zod3.z.string().optional(),
  uf: import_zod3.z.string().optional(),
  owner: import_zod3.z.object({
    cpf: import_zod3.z.string().optional(),
    cnpj: import_zod3.z.string().optional(),
    corporateName: import_zod3.z.string().optional(),
    ie: import_zod3.z.string().optional(),
    uf: import_zod3.z.string().optional(),
    type: import_zod3.z.enum(["0", "1", "2"]).optional(),
    taf: import_zod3.z.string().optional()
  }),
  nre: import_zod3.z.string().optional(),
  name: import_zod3.z.string().optional(),
  manufacturingYear: import_zod3.z.number().min(1950).optional(),
  modelYear: import_zod3.z.number().min(1950).optional(),
  mmv: import_zod3.z.string().optional()
});
