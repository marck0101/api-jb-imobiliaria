...
var update_vehicle_exports = {};
__export(update_vehicle_exports, {
  updateVehicle: () => updateVehicle
});
module.exports = __toCommonJS(update_vehicle_exports);
...
var schema3 = import_zod2.z.object({
  type: import_zod2.z.enum(["1", "2"]).optional(),
  taf: import_zod2.z.string().optional(),
  renavam: import_zod2.z.string().optional(),
  licensePlate: import_zod2.z.string().optional(),
  uf: import_zod2.z.string().optional(),
  owner: import_zod2.z.object({
    cpf: import_zod2.z.string().optional(),
    cnpj: import_zod2.z.string().optional(),
    corporateName: import_zod2.z.string().optional(),
    ie: import_zod2.z.string().optional(),
    uf: import_zod2.z.string().optional(),
    type: import_zod2.z.enum(["0", "1", "2"]).optional(),
    taf: import_zod2.z.string().optional()
  }),
  nre: import_zod2.z.string().optional(),
  name: import_zod2.z.string().optional(),
  manufacturingYear: import_zod2.z.number().min(1950).optional(),
  modelYear: import_zod2.z.number().min(1950).optional(),
  mmv: import_zod2.z.string().optional()
});
