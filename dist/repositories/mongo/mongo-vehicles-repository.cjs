...
var mongo_vehicles_repository_exports = {};
__export(mongo_vehicles_repository_exports, {
  MongoVehiclesRepository: () => MongoVehiclesRepository
});
module.exports = __toCommonJS(mongo_vehicles_repository_exports);
