...
var mongo_cteos_repository_exports = {};
__export(mongo_cteos_repository_exports, {
  MongoCteosRepository: () => MongoCteosRepository
});
module.exports = __toCommonJS(mongo_cteos_repository_exports);
