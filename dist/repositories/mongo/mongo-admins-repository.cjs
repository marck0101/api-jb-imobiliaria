...
var mongo_admins_repository_exports = {};
__export(mongo_admins_repository_exports, {
  MongoAdminsRepository: () => MongoAdminsRepository
});
module.exports = __toCommonJS(mongo_admins_repository_exports);
