...
var mongo_trips_repository_exports = {};
__export(mongo_trips_repository_exports, {
  MongoTripsRepository: () => MongoTripsRepository
});
module.exports = __toCommonJS(mongo_trips_repository_exports);
