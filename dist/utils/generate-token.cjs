...
var generate_token_exports = {};
__export(generate_token_exports, {
  generateToken: () => generateToken
});
module.exports = __toCommonJS(generate_token_exports);
...
var generateToken = (data) => import_jsonwebtoken.default.sign(data, env.SECRET_AUTH, { expiresIn: env.EXPIRE_AUTH });
